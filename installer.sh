#!/bin/bash
##setup command=wget -q "--no-check-certificate" https://raw.githubusercontent.com/ciefp/WebCamE2PrenjSF/main/installer.sh -O - | /bin/sh
#!/bin/bash
##setup command=wget -q "--no-check-certificate" https://raw.githubusercontent.com/ciefp/WebCamE2PrenjSF/main/installer.sh -O - | /bin/sh
...
TMPPATH=/tmp/WebCamE2PrenjSF

if [ ! -d /usr/lib64 ]; then
	PLUGINPATH=/usr/lib/enigma2/python/Plugins/Extensions/WebCamE2PrenjSF
else
	PLUGINPATH=/usr/lib64/enigma2/python/Plugins/Extensions/WebCamE2PrenjSF
fi
...
if [ -f /var/lib/dpkg/status ]; then
   ...
   wget https://github.com/ciefp/WebCamE2PrenjSF/archive/refs/heads/main.tar.gz
   tar -xzf main.tar.gz
   cp -r 'WebCamE2PrenjSF-main/usr' '/'
set +e
cd
sleep 2
...
echo ""
echo "#########################################################"
echo "#          WebCamE2PrenjSF INSTALLED SUCCESSFULLY          #"
